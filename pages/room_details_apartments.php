...
<section id="room_details">
	...
	<div class="main_container w1170 clearfix">
		...
		<div class="similar">
			...
			<div class="main_title_service relative t_center">
			...
			<div class="similar_rooms_wrapper relative">
				<div class="offer_container clearfix">
					...
					<div class="offer_similar col-6 left">
						...
						<div class="offer relative left">
							...
							<div class="price absolute top0">
								<span class="block t_center">$300</span>
						...
						<div class="offer relative left">
							...
							<div class="price absolute top0">
								<span class="block t_center">$400</span>
								<span class="block t_center">per night</span>
							</div>
							<div class="offer_name_wrapper relative">
								<div class="offer_name w100p t_center absolute">
					...
					<div class="offer_similar col-6 left">
						...
						<div class="offer relative left">
							...
							<div class="price absolute top0">
								<span class="block t_center">$1000</span>
								<span class="block t_center">per night</span>
							</div>
							<div class="offer_name_wrapper relative">
								<div class="offer_name w100p t_center absolute">
						...
						<div class="offer relative left">
							...
							<div class="price absolute top0">
								<span class="block t_center">$350</span>
								<span class="block t_center">per night</span>
							</div>
							<div class="offer_name_wrapper relative">
								<div class="offer_name w100p t_center absolute">
				...
				<ul class="slider_dots clearfix t_center">
					<li class="left"></li>
					<li class="left"></li>
					<li class="left"></li>
				</ul>
