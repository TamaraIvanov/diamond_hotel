	...
	<div class="main_container w1170 clearfix">
		...
		<div class="room_details_wrapper row">
			...
			<div class="col-6 left">
				...
				<div class="clearfix">
					<h3 class="left">Apartments</h3>
					<span class="right p0-5">$400 per night</span>
				</div>

				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam gravida semper augue,
                    vitae suscipit velit rutrum eu. Pellentesque habitant morbi tristique senectus et netus et
                    malesuada fames ac turpis egestas. Etiam fermentum dignissim mi, eget faucibus felis ultrices ac.</p>
				<ul class="clearfix">
