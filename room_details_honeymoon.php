	...
	<div class="main_container w1170 clearfix">
		...
		<div class="room_details_wrapper row">
			...
			<div class="col-6 left">
				...
				<div class="clearfix">
					<h3 class="left">Honeymoon Room</h3>
					<span class="right p0-5">$300 per night</span>
				</div>
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam gravida semper augue,
                    ...
                    malesuada fames ac turpis egestas. Etiam fermentum dignissim mi, eget faucibus felis ultrices ac.
                </p>
				<ul class="clearfix">
