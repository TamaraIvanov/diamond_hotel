...
<footer id="footer" class="clearfix">
	<div class="footer w1170">
		...
		<div class="gallery col-4 left p20-0">
		...
		<div class="contact_wrapper col-4 left p20">
			<span class="text_uppercase">find us</span>
	...
	<div class="footer_bottom left w100p relative">
		<p class="text_uppercase text-center p20-10">all rights reserved diamond hotel © 2017</p>
